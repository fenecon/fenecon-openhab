...
public class FeneconCessProtocolFactory {
    public static ArrayList<ModbusElementRange> getProtocol() {
        ...
        protocol.add(new ModbusElementRange(0x0100,
                new BitWordElement("Unit_state", new OnOffBitItem(0, "System_warning_state"),
                        new OnOffBitItem(1, "System_fault_state"), new OnOffBitItem(2, "System_power_decrease_state"),
                        new OnOffBitItem(3, "System_complete_charge_state"),
                        new OnOffBitItem(4, "System_complete_discharge_state")),
                new BitWordElement("Unit_work_state", new OnOffBitItem(0, "Initial"), new OnOffBitItem(1, "Fault"),
                        new OnOffBitItem(2, "Stop"), new OnOffBitItem(3, "Standby"),
                        new OnOffBitItem(4, "Grid_Monitoring"), new OnOffBitItem(5, "Ready"),
                        new OnOffBitItem(6, "Running"), new OnOffBitItem(7, "Debug")),
                new BitWordElement("Unit_ctrl_mode", new OnOffBitItem(0, "Remote"), new OnOffBitItem(1, "Fault"),
                        new OnOffBitItem(2, "Stop")),
                new BitWordElement("Unit_work_mode", new OnOffBitItem(5, "Island"))));
        protocol.add(new ModbusElementRange(0x0110,
                new BitWordElement("Suggestive_information", new OnOffBitItem(2, "Emergency_stop")),
        ...
        protocol.add(new ModbusElementRange(0x0125,
                new BitWordElement("Suggestive_information", new OnOffBitItem(0, "Inverter_communication_abnormity"),
                ...
                new BitWordElement("Suggestive_information", new OnOffBitItem(0, "Environment_severe_overtemperature"),
                        new OnOffBitItem(3, "Transformer_severe_overtemperature"))));
        protocol.add(
                new ModbusElementRange(0x0150,
                        new BitWordElement("Switch_state", new OnOffBitItem(0, "DC_breaker_state"),
                                new OnOffBitItem(1, "DC_main_contactor_state"), new OnOffBitItem(2,
                                        "DC_precharge_contactor_state"),
                                new OnOffBitItem(3, "AC_breaker_state"), new OnOffBitItem(4, "AC_main_contactor_state"),
                        ...
                        new BitWordElement("Switch_state", new OnOffBitItem(0, "Overcurrent_self_lock_state"),
                                new OnOffBitItem(1, "Remote_start_signal_state"),
                                new OnOffBitItem(2, "Work_door_state"), new OnOffBitItem(3, "UC_state"),
                                new OnOffBitItem(4, "Neutral_wire_contactor_state"),
                                new OnOffBitItem(5, "On_off_grid_contactor_state"))));
        protocol.add(new ModbusElementRange(0x0158,
                new BitWordElement("Software_switch", new OnOffBitItem(0, "Inverter_communication_protection"),
        ...
        protocol.add(new ModbusElementRange(0x180,
                new BitWordElement("Abnormity", new OnOffBitItem(0, "DC_precharge_contactor_close_unsuccessfully"),
        ...
        protocol.add(new ModbusElementRange(0x182,
                new BitWordElement("Abnormity", new OnOffBitItem(0, "DC_short_circuit_protection"),
                ...
                new BitWordElement("Abnormity", new OnOffBitItem(0, "Phase_A_invert_voltage_sampling_invalidation"),
                ...
                new BitWordElement("Abnormity", new OnOffBitItem(0, "Phase_A_grid_loss"),
                        new OnOffBitItem(1, "Phase_B_grid_loss"), new OnOffBitItem(2, "Phase_C_grid_loss"),
                ...
                new BitWordElement("Suggestive_information",
                        ...
                        new OnOffBitItem(12, "Work_door_open"), new OnOffBitItem(13, "Emergency_stop"),
                        new OnOffBitItem(14, "AC_breaker_close_unsuccessfully"),
                        new OnOffBitItem(15, "Control_switch_stop")),
                new BitWordElement("Suggestive_information", new OnOffBitItem(0, "General_overload"),
                        new OnOffBitItem(1, "Severe_overload"), new OnOffBitItem(2, "Battery_current_over_limit"),
                        ...
                        new OnOffBitItem(7, "Pole_board_invalidation"), new OnOffBitItem(8, "Self_inspection_failed"),
        ...
        protocol.add(new ModbusElementRange(0x0200, new DecimalWordItem("DC_Voltage"),
                new DecimalWordItem("DC_Current"), new DecimalWordItem("DC_Power")));
        protocol.add(new ModbusElementRange(0x0210, new DecimalWordItem("P"), new DecimalWordItem("Q"),
                new DecimalWordItem("S"), new DecimalWordItem("Ia"), new DecimalWordItem("Ib"),
                new DecimalWordItem("Ic")));
        protocol.add(new ModbusElementRange(0x0219, new DecimalWordItem("Ua"), new DecimalWordItem("Ub"),
                new DecimalWordItem("Uc"), new DecimalWordItem("Frequency")));
        protocol.add(new ModbusElementRange(0x0240, new DecimalWordItem("IPM_Phase_A_temperature"),
                new DecimalWordItem("IPM_Phase_B_temperature"), new DecimalWordItem("IPM_Phase_C_temperature")));
        protocol.add(new ModbusElementRange(0x0246, new DecimalWordItem("Environment_temperature")));
        protocol.add(new ModbusElementRange(0x0249, new BitWordElement("Transformer_Phase_B_temperature")));
        protocol.add(new ModbusElementRange(0x024F, new BitWordElement("Environment_humidity")));
        protocol.add(
                new ModbusElementRange(0x0500,
                        new BitWordElement("Work_state_control_command", new OnOffBitItem(2, "Stop"),
                                new OnOffBitItem(3, "Standby"), new OnOffBitItem(5, "Ready"),
                                new OnOffBitItem(6, "Run"))));
        protocol.add(new ModbusElementRange(0x0600,
                new BitWordElement("Control_mode_control_command", new OnOffBitItem(0, "Remote"),
                        new OnOffBitItem(1, "Local_Manual"), new OnOffBitItem(2, "Local_Auto")),
                new BitWordElement("Work_mode_control_command", new OnOffBitItem(5, "Island")),
                new DecimalWordItem("Clear_abnormity")));
        protocol.add(new ModbusElementRange(0x0635, new DecimalWordItem("System_Min_SOC"),
                new DecimalWordItem("System_Max_SOC")));

        protocol.addAll(getPCSInformation("DCDC0", 0));
        protocol.addAll(getPCSInformation("DCDC1", 0x300));
        protocol.addAll(getPCSInformation("PV", 0x600));

        // BMS
        protocol.add(new ModbusElementRange(0x1100,
                new BitWordElement("Battery_string_1_work_state", new OnOffBitItem(0, "Initial"),
                        new OnOffBitItem(1, "Stop"), new OnOffBitItem(2, "Starting_up"), new OnOffBitItem(3, "Running"),
                        new OnOffBitItem(4, "Fault")),
                new BitWordElement("Battery_string_1_switch_state", new OnOffBitItem(0, "Main_contactor"),
                        new OnOffBitItem(1, "Precharge_contactor"), new OnOffBitItem(2, "FAN_contactor"),
                        new OnOffBitItem(3, "BMU_power_supply_relay"), new OnOffBitItem(4, "Middle_relay")),
                new BitWordElement("Battery_string_1_peripheral_IO_state", new OnOffBitItem(0, "Fuse_state"),
        ...
        protocol.add(new ModbusElementRange(0x1105,
        ...
        protocol.add(new ModbusElementRange(0x1400, new DecimalWordItem("Battery_string_1_total_voltage"),
                new DecimalWordItem("Battery_string_1_total_current"), new DecimalWordItem("Battery_string_1_SOC"),
                new DecimalWordItem("Battery_string_1_SOH"),
                new DecimalWordItem("Battery_string_1_cell_average_temperature")));
        protocol.add(new ModbusElementRange(0x1406, new DecimalWordItem("Battery_string_1_charge_current_limit"),
                new DecimalWordItem("Battery_string_1_discharge_current_limit")));
        protocol.add(new ModbusElementRange(0x140A, new DecimalWordItem("Battery_string_1_charge_discharge_times_LSW"),
                new DecimalWordItem("Battery_string_1_charge_discharge_times_MSW")));
        protocol.add(
                new ModbusElementRange(0x1418, new DecimalWordItem("Battery_string_1_accumulated_charge_energy_LSW"),
        ...
        protocol.add(new ModbusElementRange(0x1430, new DecimalWordItem("Battery_string_1_Max_cell_voltage_battery_NO"),
        ...
        protocol.add(
                new ModbusElementRange(0x143A, new DecimalWordItem("Battery_string_1_Max_cell_temperature_battery_NO"),
        ...
        protocol.add(new ModbusElementRange(0x1500, new DecimalWordItem("Battery_string_1_cell_1_voltage"),
                new DecimalWordItem("Battery_string_1_cell_2_voltage")));
        // 0x1700~0x18FF: Each address means one battery cell
        protocol.add(new ModbusElementRange(0x1700, new DecimalWordItem("Battery_string_1_cell_1_temperature"),
    ...
    private static ArrayList<ModbusElementRange> getPCSInformation(String device, int offset) {
        ArrayList<ModbusElementRange> protocol = new ArrayList<ModbusElementRange>();
        protocol.add(new ModbusElementRange(0xA000 + offset,
                new BitWordElement(device + "_Work_state", new OnOffBitItem(1, "Self_checked"),
                        new OnOffBitItem(2, "Idle"), new OnOffBitItem(3, "Ready"), new OnOffBitItem(4, "Running"),
                        new OnOffBitItem(5, "Fault"), new OnOffBitItem(6, "Debug"), new OnOffBitItem(7, "Locked"),
                        new OnOffBitItem(1, "Impulse")),
                new BitWordElement(device + "_Work_state", new OnOffBitItem(4, "Const_current"),
                        new OnOffBitItem(5, "Const_volt"), new OnOffBitItem(9, "Boost_MPPT"))));
        protocol.add(new ModbusElementRange(0xA100 + offset,
                new BitWordElement(device + "_Suggestive_information",
                        ...
                        new OnOffBitItem(7, "Update_EEPROM_failed"), new OnOffBitItem(8, "Read_EEPROM_failed"),
                ...
                new BitWordElement(device + "_Suggestive_information",
                        ...
                        new OnOffBitItem(8, "Fan_1_stop_failed"), new OnOffBitItem(9, "Fan_2_stop_failed"),
                        new OnOffBitItem(10, "Fan_3_stop_failed"), new OnOffBitItem(11, "Fan_4_stop_failed"),
                        new OnOffBitItem(12, "Fan_1_startup_failed"), new OnOffBitItem(13, "Fan_2_startup_failed"),
                        new OnOffBitItem(14, "Fan_3_startup_failed"), new OnOffBitItem(15, "Fan_4_startup_failed")),
                new BitWordElement(device + "_Suggestive_information",
        ...
        protocol.add(new ModbusElementRange(0xA110 + offset, new BitWordElement(device + "_Abnormity",
                ...
                new OnOffBitItem(6, "DC_Converter_IGBT_fault"), new OnOffBitItem(7, "DC_Converter_Precharge_unmet")),
                ...
                new BitWordElement(device + "_Abnormity", new OnOffBitItem(0, "DC_Convertor_general_overload"),
                        new OnOffBitItem(1, "DC_short_circuit"), new OnOffBitItem(2, "Peak_pulse_current_protection"),
                ...
                new BitWordElement(device + "_Abnormity", new OnOffBitItem(0, "DC_Converter_chanel_1_over_temperature"),
        ...
        protocol.add(new ModbusElementRange(0xA120,
                new BitWordElement(device + "_Switch_state", new OnOffBitItem(0, "DC_precharge_contactor"),
                        new OnOffBitItem(1, "DC_main_contactor"), new OnOffBitItem(2, "Output_contactor"),
                        new OnOffBitItem(3, "Output_breaker"), new OnOffBitItem(4, "Input_breaker"),
                        new OnOffBitItem(5, "AC_contactor"), new OnOffBitItem(6, "Emergency_stop_button"))));
        protocol.add(new ModbusElementRange(0xA130, new DecimalWordItem(device + "_Output_voltage"),
                new DecimalWordItem(device + "_Output_current"), new DecimalWordItem(device + "_Output_power"),
                new DecimalWordItem(device + "_Input_voltage"), new DecimalWordItem(device + "_Input_current"),
                new DecimalWordItem(device + "_Input_power")));
        protocol.add(new ModbusElementRange(0xA140, new DecimalWordItem(device + "_Reactor_temperature"),
                new DecimalWordItem(device + "_IGBT_temperature")));
        protocol.add(new ModbusElementRange(0xA200,
