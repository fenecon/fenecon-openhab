...
import org.openhab.binding.fems.handler.FemsHandler;
...
public class FemsHandlerFactory extends BaseThingHandlerFactory {
    ...
    private final static Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections
            .singleton(FemsBindingConstants.THING_TYPE_IO);
    ...
    protected ThingHandler createHandler(Thing thing) {
        ...
        if (thingTypeUID.equals(FemsBindingConstants.THING_TYPE_IO)) {
            return new FemsHandler(thing);
        }
